            ...
            OrangeClock:function(options){
                ...
                function doInit(){
                    ...
                    var clockWidth = jQ.isNumeric(defaultOptions.width) ? defaultOptions.width : clock_default_width,
                        ...
                        clockAlign = jQ.type(defaultOptions.align) === "string" ? defaultOptions.align : clock_default_align;
                    clock.css({"width":clockWidth+"px","height":clockHeight+"px","float":clockAlign});
                    if(clockAlign === clock_default_align)
                        clock.removeClass("clock_align_right").addClass("clock_align_left");
                    else
                        clock.removeClass("clock_align_left").addClass("clock_align_right");
                    clock.empty();
                    var radius = 160;
                    ...
                    var initClockString ="<div class='origin'></div><div class='dot_box'>" + 
                                        "<div class='clock_line hour_line' id='" + clock_id + "_hour_line'></div>" +
                    ...
                    initClockString += "</div><div class='clock_line hour_line' id='hour_line'></div>" +
                                        ...
                                        "<div class='time_info'><div class='time' id='hour_time'></div><div class='time' id='minute_time'></div><div class='time' id='second_time'></div></div>";
                    for(var i = 0; i < 60; i++) {
